...
var LOCALES = {
  en: {
    ...
    privacy_authority_detail: 'You have the right to lodge a complaint with a data protection supervisory authority (Art. 77 GDPR). The competent authority is: Bayerisches Landesamt für Datenschutzaufsicht (BayLDA), Promenade 18, 91522 Ansbach — lda.bayern.de.',
  ...
  de: {
    ...
    privacy_authority_detail: 'Sie haben das Recht, sich bei einer Datenschutz-Aufsichtsbehörde zu beschweren (Art. 77 DSGVO). Zuständig ist: Bayerisches Landesamt für Datenschutzaufsicht (BayLDA), Promenade 18, 91522 Ansbach — lda.bayern.de.',
  ...
  zh: {
    ...
    enter_name: '输入名字...', touchpad: '触控板', privacy: '隐私', imprint: '法律声明',
  ...
  ko: {
    ...
    enter_name: '이름 입력...', touchpad: '터치패드', privacy: '개인정보', imprint: '법적 고지',
